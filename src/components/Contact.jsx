        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-start gap-8 mb-12">
            ...
            <a 
              ...
              className="flex items-center gap-2 text-xs font-black uppercase tracking-wider bg-white/10 hover:bg-white hover:text-[#0077b5] border border-white/20 px-4 py-2 rounded-full transition-all duration-300"
            >
